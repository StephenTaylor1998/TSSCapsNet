...
class Block(layers.Layer):
    def __init__(self, in_planes, out_planes, expansion, stride, weight_decay=1e-4):
        ...
        self.conv1 = layers.Conv2D(filters=planes, kernel_size=1, strides=1, padding='valid',
        ...
        self.conv3 = layers.Conv2D(filters=out_planes, kernel_size=1, strides=1, padding='valid', use_bias=False,
