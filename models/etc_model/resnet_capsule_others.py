...
from models.etc_model.resnet_cifar import build_graph as build_resnet_backbone
...
def capsnet_graph(input_shape, num_classes, routing_name, depth=18):
    ...
    # (32, 32, 3) ==>> (8, 8, 128)
    x = build_resnet_backbone(input_shape, num_classes, depth, half=False, backbone=True)(inputs)
